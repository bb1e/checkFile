...
const char *gengetopt_args_info_help[] = {
  ...
  "  -f, --file=STRING   file(s)",
  "  -b, --batch=STRING  txt file with names/paths",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->dir_given = 0 ; args_info->dir_group = 0 ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_multiple_string_field (args_info->dir_given, &(args_info->dir_arg), &(args_info->dir_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  write_multiple_into_file(outfile, args_info->dir_given, "dir", args_info->dir_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->batch_given)
    {
      fprintf (stderr, "%s: '--batch' ('-b') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (check_multiple_option_occurrences(prog_name, args_info->dir_given, args_info->dir_min, args_info->dir_max, "'--dir' ('-d')"))
     error_occurred = 1;
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * dir_list = NULL;
  int error_occurred = 0;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'f':	/* file(s).  */
          ...
          break;
        case 'b':	/* txt file with names/paths.  */
        ...
        case 'd':	/* directory.  */
          ...
          if (update_multiple_arg_temp(&dir_list, 
              &(local_args_info.dir_given), optarg, 0, 0, ARG_STRING,
              "dir", 'd',
              additional_error))
            goto failure;
          if (!args_info->dir_group)
            {
              args_info->dir_group = 1;
              args_info->grp1_group_counter += 1;
            }
  ...
  update_multiple_arg((void *)&(args_info->dir_arg),
    &(args_info->dir_orig), args_info->dir_given,
    local_args_info.dir_given, 0,
    ARG_STRING, dir_list);

  args_info->file_given += local_args_info.file_given;
  local_args_info.file_given = 0;
  args_info->dir_given += local_args_info.dir_given;
  local_args_info.dir_given = 0;
